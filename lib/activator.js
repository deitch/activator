...
// with defaults
var async = require('async'), crypto = require('crypto'), smtp = require('./mailer'), _ = require('lodash'), mailer, attachments, styliner,
...
module.exports = {
	init: function (config) {
		...
		mailer = smtp(transport,templates, config.styliner);
    attachments = config.attachments || DEFAULTS.attachments;
		...
		styliner = config.styliner || DEFAULTS.styliner;
	},
